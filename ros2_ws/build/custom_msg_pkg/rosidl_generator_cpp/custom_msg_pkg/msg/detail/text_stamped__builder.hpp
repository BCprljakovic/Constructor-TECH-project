...
class Init_TextStamped_id
{
public:
  explicit Init_TextStamped_id(::custom_msg_pkg::msg::TextStamped & msg)
  : msg_(msg)
  {}
  ::custom_msg_pkg::msg::TextStamped id(::custom_msg_pkg::msg::TextStamped::_id_type arg)
  {
...
public:
  ...
  : msg_(msg)
  {}
  Init_TextStamped_id text(::custom_msg_pkg::msg::TextStamped::_text_type arg)
  {
    msg_.text = std::move(arg);
    return Init_TextStamped_id(msg_);
  }
