...
static rosidl_typesupport_introspection_c__MessageMember custom_msg_pkg__msg__TextStamped__rosidl_typesupport_introspection_c__TextStamped_message_member_array[3] = {
  {
    "timestamp",  // name
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg_pkg__msg__TextStamped, id),  // bytes offset in struct
    NULL,  // default value
    NULL,  // size() function pointer
    NULL,  // get_const(index) function pointer
    NULL,  // get(index) function pointer
